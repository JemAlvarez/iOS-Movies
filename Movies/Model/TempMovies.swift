...
struct TempMovies {
    ...
    static let tv = TV(id: 012, backdrop_path: "space_force", genres: [Genre(id: 123, name: "Comedy")], overview: "A four-star general begrudgingly teams up with an eccentric scientist to get the U.S. military's newest agency — Space Force — ready for lift-off.", poster_path: "space_force", first_air_date: "2020", episode_run_time: [30, 32], name: "Space Force", vote_average: 7.1, number_of_seasons: 1)
